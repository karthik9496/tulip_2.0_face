...
const GrievanceDprTaskWise = () => {
  ...
  function generateSectionWiseDprPdf(fromDateStr, toDateStr) {
    setLoading(true);
    setGeneratingPdf(true);
    axios
      .get(
        `/grievances/print/sectionWiseDpr?fromDate=${fromDateStr}&toDate=${toDateStr}`
      )
      .then((response) => {
        setLoading(false);
  ...
  const generateGrievanceDPR = () => {
    ...
    async function fetchData() {
      if (!saving) {
        ...
        await axios
          .get(
            `/reports/grievance-dpr/sectionWise?fromDate=${fromDateStr}&toDate=${toDateStr}`
          )
          .then((response) => {
            setLoading(false);
  ...
  const ShowGrievanceDPR = () => {
    ...
    async function breakUp(sectionname, fromDateStr, toDateStr) {
      let record = "";
      ...
      await axios
        .get(
          `/reports/grievance-dpr/section-wise/${sectionname}/dprBreakup?fromDateStr=${fromDateStr}&toDateStr=${toDateStr}`
        )
        .then((response) => {
          console.log("response>>", response.data);
      ...
      () => [
        ...
        },
        {
          ...
          Cell: ({ row }) => (
            <div>
              <p
                className=" text-center w-16 m-0 p-0 bg-green-300 hover:bg-green-500 cursor-pointer"
                onClick={() => {
                  setSectionname(row.original.sectionname);
                  breakUp(row.original.sectionname, fromDateStr, toDateStr);
    ...
    return (
      <div className="min-h-full bg-gray-100 text-gray-900">
          ...
          <div className="-mt-2 max-h-full py-0 ml-0">
            <div className="flex flex-row-reverse">
              <button
                ...
                onClick={() =>
                  generateSectionWiseDprPdf(fromDateStr, toDateStr)
                }
              >
                Generate Pdf
              </button>
        ...
        <main id="section" className="pt-8">
          <div className="min-h-full bg-gray-100 text-gray-900">
            <div className="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
              <form>
                {sectionname ? (
                  <h1 className="text-green-700 text-4xl mb-8" align="center">
                    Section - {sectionname}
                  </h1>
                ) : (
                  ""
                ...
                {auditorList && (
                  <div className="container">
                    <h1 className="text-blue-600" align="center">
                      Breakup Details---- Pending at Auditor Level
                    </h1>
                ...
                <div className="container">
                  <h1 className="text-blue-600" align="center">
                    Breakup Details---- Pending at AAO Level
                  </h1>
                  <table className="table table-striped table-bordered">
                    <thead>
                      <tr>
                ...
                <div className="container">
                  <h1 className="text-blue-600" align="center">
                    Breakup Details---- Pending at SAO/AO Level
                  </h1>
                  <table className="table table-striped table-bordered">
                    <thead>
                      <tr>
                ...
                <div className="container">
                  <h1 className="text-blue-600" align="center">
                    Breakup Details---- Pending at WO Level
                  </h1>
                  <table className="table table-striped table-bordered">
                    <thead>
                      <tr>
                ...
                <div className="container">
                  <h1 className="text-blue-600" align="center">
                    Breakup Details---- Pending at Additional CDA Level
                  </h1>
                  <table className="table table-striped table-bordered">
                    <thead>
                      <tr>
                ...
                <div className="container">
                  <h1 className="text-blue-600" align="center">
                    Breakup Details---- Pending at PCDA Level
                  </h1>
                  <table className="table table-striped table-bordered">
                    <thead>
                      <tr>
