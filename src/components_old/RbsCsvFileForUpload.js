...
const RbsCsvFileForUpload = () => {
	...
	async function generateCsv() {
		await axios.get(`/rbsTrans/generateUploadCsv/${me}`)
			.then((response) => {
		...
		<div className="min-h-screen bg-gray-100 text-gray-900">
			<main className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
				<div className=" ">
					...
					<h1 className="text-xl font-semibold ml-4">Upload File For Rbs</h1>
...
export default withRouter(RbsCsvFileForUpload);