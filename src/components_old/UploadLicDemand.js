...
const fileChangeHandler = () => {
	 ...
	 setDisabled(true);
		...
		axios.post("/licDemandTransactions/upload/licDemand", formData, {
			headers: {
					...
					<div className="row">
						<div className="col-md-6">
							<div className="form-group files color">
								<label>Upload Lic Demand File  </label>
...
export default withRouter(UploadLicDemand);