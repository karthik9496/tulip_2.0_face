...
function IorTransApprovedList() {
	...
	useEffect(() => {
		...
		async function fetchData() {
			...
			await axios.get('/iorTrans/approvedList/iors?search=' + search + '&rentBillType=' + optionType)
		...
		<div className="min-h-screen bg-gray-100 text-gray-900">
			<main className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
				<div className="mt-2 ml-4">
					<h1 className="text-xl font-semibold">Initial Occupation Return Transactions-Approved(IOR)</h1>
...
export default withRouter(IorTransApprovedList);
