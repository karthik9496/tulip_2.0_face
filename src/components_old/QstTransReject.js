...
const QstTransReject = () => {
	...
	const onSubmit = (data, event) => {
		...
		console.log(data);
		if (data.id) {
			axios.put("/qstTrans/reject/" + data.id, data)
				.then((response) => {
					...
					<div className="grid grid-cols-3 gap-0">
						 ...
						 <div className="grid grid-cols-3 gap-0">
								...
								<div>
									...
									<input type="date" name="elecFromDate" {...register("elecFromDate")}readOnly
									className="form-control py-0" />
								...
								<div>
									...
									<input type="date" name="elecToDate" {...register("elecToDate")}readOnly
									className="form-control py-0" />
								...
								<div>
									...
									<input type="text" name="elecUnit" {...register("elecUnit")}readOnly
										className="form-control py-0"
									/>
								...
								<div>
									...
									<input type="text" name="elecAmount" {...register("elecAmount")}readOnly
										className="form-control py-0"
									/>
								...
								<div>
									...
									<input type="text" name="elecDuty" {...register("elecDuty")}readOnly
										className="form-control py-0"
									/>
								...
								<div>
									...
									<input type="date" name="powerFromDate" {...register("powerFromDate")}readOnly
									className="form-control py-0" />
								...
								<div>
									...
									<input type="date" name="powerToDate" {...register("powerToDate")}readOnly
									className="form-control py-0" />
								...
								<div>
									...
									<input type="text" name="powerUnit" {...register("powerUnit")}readOnly
										className="form-control py-0"
									/>
								...
								<div>
									...
									<input type="date" name="powerAmount" {...register("powerAmount")}readOnly
									className="form-control py-0" />
								...
								<div>
									...
									<input type="date" name="waterFromDate" {...register("waterFromDate")}readOnly
									className="form-control py-0" />
								...
								<div>
									...
									<input type="date" name="waterToDate" {...register("waterToDate")}readOnly
									className="form-control py-0" />
								...
								<div>
									...
									<input type="text" name="waterUnit" {...register("waterUnit")}readOnly
										className="form-control py-0"
									/>
...
export default withRouter(QstTransReject);