...
function OccVacViewMaster() {
	...
	useEffect(() => {
		...
		async function fetchData() {
			if (!fetching)
				console.log(cdaoNo);
			await axios.get('/occupationVacations/occVac/approved?cdaoNo=' + cdaoNo)
				.then((response) => {
		...
		<div className="min-h-screen bg-gray-100 text-gray-900">
			<main className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
				<div className="mt-2 ml-4">
					<h1 className="text-xl font-semibold">Occupation Vacation Master</h1>
...
export default withRouter(OccVacViewMaster);
