...
function RbsRejectedList() {
	...
	useEffect(() => {
		...
		async function fetchData() {
			...
			await axios.get('/rbsTrans/rejectedList/rbs?search='+search)
		...
		<div className="min-h-screen bg-gray-100 text-gray-900">
			<main className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
				<div className="mt-2 ml-4">
					<h1 className="text-xl font-semibold">Single Rent Bill Rejected Transactions(SRB)</h1>
...
export default withRouter(RbsRejectedList);
