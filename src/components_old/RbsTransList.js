...
function RbsTransList() {
	...
	useEffect(() => {
		...
		async function fetchData() {
			...
			await axios.get('/rbsTrans?search='+search+'&lfee='+lfee+'&power='+power+'&water='+water+'&light='+light)
				...
				<div className="mt-2 ml-4">
					...
					<div className="flexContainer">
						...
						onBlur={e => setInputText(e.target.value)}							
							...
							<div>	
						<input type="text" name="lfee" placeholder="lfee amount"
						onBlur={e => setLfee(e.target.value)}							
							className="w-32 m-2 p-1 float-left..."/>
							</div>
							<div>	
						<input type="text" name="power" placeholder="power amount"
						onBlur={e => setPower(e.target.value)}							
							className="w-32 m-2 p-1 float-left..."/>
							</div>
							<div>	
						<input type="text" name="water" placeholder="water amount"
						onBlur={e => setWater(e.target.value)}							
							className="w-32 m-2 p-1 float-left..."/>
							</div>
							<div>	
						<input type="text" name="light" placeholder="light amount"
						onBlur={e => setLight(e.target.value)}							
							className="w-32 m-2 p-1 float-left..."/>
							</div>
							<br/>
							 <div>
						...
						<div>
					<Link to={"/rbsTrans/new"}>
								<button className="w-42 m-2 p-1 float-left..." > Add Single Rent Bill </button>
							</Link>
					</div>
					<div>
						
						
							<Link to={"/rbsTrans/approvedList/rbs"}>
								<button className="w-36 m-2 p-1 float-left..." > Approved Rbs </button>
							</Link>
						...
						<div>
							...
							<Link to={"/rbsTrans/manualEntryList/rbs"}>
								<button className="w-42 m-2 p-1 float-left..." > Manual Rbs </button>
							</Link>
						...
						<div>
							...
							<Link to={"/rbsTrans/rejectedList/rbs"}>
								<button className="w-42 m-2 p-1 float-left..." > Invalid/Rejected Rbs </button>
							</Link>
						...
						<Link to={"/rbsTrans/list/bdv"}>
								<button className="w-36 m-2 p-1 float-left..." > BD Voucher </button>
							</Link>
						...
						<Link to={"/rbsTrans/list/drr"}>
								<button className="w-36 m-2 p-1 float-left..." > Damage Rent </button>
							</Link>
						...
						<div>
							...
							{(usrLevel===30) &&
						<Link to={"/rbsTrans/generateUploadCsv"}>
...
export default withRouter(RbsTransList);
