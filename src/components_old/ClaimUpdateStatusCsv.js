...
const ClaimUpdateStatusCsv = () => {
	...
	//	console.log(">>>>>>To Date--:" + toDate);
		async function csvFile() {
			...
			console.log(">>>>>>From Date--:" + fromDate);
		console.log(">>>>>>To Date--:" + toDate);
				axios.get(`/reports/dak/${fromDateStr}/${toDateStr}/fetchClaimData`)
					.then((response) => {
		...
		<div className="min-h-screen bg-gray-100 text-gray-900">
			<main className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
				<div className=" ">
					...
					<h1 className="text-xl font-semibold ml-4">Update Claim Status CSV</h1>
...
export default withRouter(ClaimUpdateStatusCsv);