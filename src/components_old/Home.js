    ...
    <div className="p-0">
      ...
      <Deductions /> */}
          ...
          <Alert variant="success">
            ...
            <hr />
            <p>
              The Falcon project is for maintaining the Pay and Allowances of
              the Officers of Indian Army.
            </p>
            <br />
          </Alert>
          ...
          <Alert variant="warning">
            ...
            <ul className="list-disc ml-2">
              <li>November Masters updated in Falcon.</li>
            </ul>
          </Alert>
