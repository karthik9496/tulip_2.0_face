...
const IorTransRevisionEdit = () => {
	...
	const [rentType,setRentType]=useState('Revision');
	...
	//	setButtonDisabled(true);
		...
		if (data.id) {
			...
			if(vacRej!=='R'){
			axios.put(`/iorTrans/revisionValidate/${vacId}/` + data.id, data)
				.then((response) => {
		...
		<div className="min-h-screen bg-gray-100 text-gray-900">
			<div className="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
				...
				<form onSubmit={handleSubmit(onSubmit, onError)}>
					<h1 >{id === 'new' ? 'Add' : 'Edit'} Initial Occupation Return--Revision Edit </h1>
		 ...
		 <br/>
						 ...
						 <h1 class="text-blue-600" align="center">Revision Details</h1>
							<div className="grid grid-cols-5 gap-0">
...
export default withRouter(IorTransRevisionEdit);