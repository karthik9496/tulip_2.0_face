...
const fileChangeHandler = () => {
	 ...
	 setDisabled(true);
		...
		axios.post("/licMaturityTransactions/upload/licMaturity", formData, {
			headers: {
					...
					<div className="row">
						<div className="col-md-6">
							<div className="form-group files color">
								<label>Upload Lic Maturity File  </label>
...
export default withRouter(UploadLicMaturity);