...
function PaySummaryList() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      if (!fetching)
        await axios
          .get("/paySummarys?cdaoNo=" + cdaoNo+'&me='+me+'&rankCode='+rankCodeSearch)
          .then((response) => {
      ...
      <main className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        <div className="mt-2 ml-4">
          ...
          <div>
            ...
            <div/>
						<button className="w-46 ml-8 p-0 h-2 -mt-2" type="submit" onClick={generateNominalRoll} >Generate Nominal Roll</button>
...
export default withRouter(PaySummaryList);
