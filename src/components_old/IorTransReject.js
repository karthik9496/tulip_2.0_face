...
const IorTransReject = () => {
	...
	const onSubmit = (data, event) => {
		...
		if (data.id) {
			axios
				.put("/iorTrans/reject/" + data.id, data)
				.then((response) => {
		...
		if (manCheck === true) {
			...
			axios.put("/iorTrans/submitHighValue/" + data.id, data)
				.then((response) => {
	...
	const rollBack=(e)=>{
		console.log("-------------rollback---------:" + id);
			axios.put(`/iorTrans/rollBack/${id}`)
				.then((response) => {
					setMesg(response.data);
					setDisabled(false);
				})
							...
							<div className="grid grid-cols-3 gap-0">
								...
								<div>
									...
									<select
										...
										{...register("occupationVacationRevision")} readOnly
									>
								...
								<div>
									...
									<input type="text" className="text-red-500" name="rentAmountCr" 
									{...register("rentAmountCr")} readOnly
								...
								<div>
									...
									<input type="text" className="text-red-500" name="furAmountCr" 
									{...register("furAmountCr")} readOnly
								...
								<div>
									...
									<input type="text" className="text-red-500" name="rentAmountTotal" 
									{...register("rentAmountTotal")} readOnly
								...
								<div>
									...
									<input type="text" className="text-red-500" name="furAmountTotal" 
									{...register("furAmountTotal")}readOnly
								...
								{usrLevel>=30 &&
								<div className="px-2">
									<button type="button" onClick={rollBack} >Roll Back</button>
								</div>
								}
...
export default withRouter(IorTransReject);